# 10. Security Operations Center (SOC) Teams – Practical Playbook

## 1. What this playbook gives you

This playbook explains how security operations center (soc) teams can work day to day inside our on-prem, security-first software factory.
...
- Detecting real attacks in noisy logs and alerts.
- Understanding application context behind events.
- Coordinating with product teams during incidents.
...
- Tuning backlogs for SIEM rules
