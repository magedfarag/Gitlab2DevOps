# 16. Vendors and Strategic Partners – Practical Playbook

## 1. What this playbook gives you

This playbook explains how vendors and strategic partners can work day to day inside our on-prem, security-first software factory.
...
- Aligning delivery and support processes with the factory model.
- Providing security evidence and SBOMs on demand.
- Integrating product updates into an on-prem CI/CD ecosystem.
...
- Integration guides
- SBOMs and vulnerability disclosures
- Support and escalation procedures
- Release calendars and compatibility matrices
