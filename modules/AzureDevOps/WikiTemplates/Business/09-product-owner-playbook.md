# 09. Product Owners and Product Managers – Practical Playbook

## 1. What this playbook gives you

This playbook explains how product owners and product managers can work day to day inside our on-prem, security-first software factory.
...
- Prioritising features, reliability, and security work in one backlog.
- Connecting delivery metrics to real product outcomes.
- Handling stakeholder pressure for scope and fixed deadlines.
...
- Prioritised backlog
- Outcome and hypothesis statements
