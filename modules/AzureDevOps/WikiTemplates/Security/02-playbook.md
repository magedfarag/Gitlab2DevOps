# 02. Cybersecurity and Application Security – Practical Playbook

## 1. What this playbook gives you

This playbook explains how cybersecurity and application security can work day to day inside our on-prem, security-first software factory.
...
- Visibility of application risks across portfolios.
- Scaling threat modelling and secure coding without blocking delivery.
- Ensuring tool findings are triaged and not ignored.
...
- Security tool policies and tuning configs
- Risk register entries and exceptions
